...
A machine learning–powered web application built using Streamlit that predicts the price of a vehicle based on its specifications.
This project uses a custom-trained regression model and a clean UI for real-time predictions.
